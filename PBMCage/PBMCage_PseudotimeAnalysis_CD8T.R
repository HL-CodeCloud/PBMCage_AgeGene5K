...
saveRDS(fate_res, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_CD8T.slim_fateSelectionTest.rds")
...
p_withLabel=
  ...
  ggrepel::geom_label_repel(data=midpoint %>% group_by(Annot.detailed) %>% summarize_at(c("umap_1","umap_2"), mean),
                            ...
                            alpha=0.8, size=3, label.padding=0.2, lineheight=1, box.padding=0.5,
                            color="black") +
...
pdf("~/Project_PBMCage/Plots/PBMCage_Plots/Pseudotime_Trajectory_CD8T.pdf", height=3.5, width=7.5)
plot(p_withLabel)
dev.off()

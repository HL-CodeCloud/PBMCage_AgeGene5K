...
# CD8T=subset(THEObj, Annot.rough=="OtherT" | Annot.inter=="Other.progenitor" | Annot.inter %in% c("Other.ILC"))
# # maybe wrong annotation, removed
# CD8T=subset(CD8T, Annot.detailed!="OtherT.NKT.MKI67" & Annot.detailed!="OtherT.gdT.LEF1")
...
#   mutate(Annot.detailed=ifelse(Annot.detailed %in% c("Other.ILC.GATA3","Other.ILC.ID3"),"Other.ILC",Annot.detailed))
# 
...
# saveRDS(df, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_Umap.rds")
# 
...
#   geom_text(data=df %>% group_by(Annot.detailed) %>% summarize_at(c("umap_1","umap_2"), mean), 
#             inherit.aes=F,
...
df=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_Umap.rds")
...
sds=slingshot(rd, df$Annot.detailed, start.clus="Other.progenitor.HSPC",
              end.clus=c("OtherT.MAIT","OtherT.NKT","OtherT.gdT.CMC1","Other.ILC"))
saveRDS(sds, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_sds_origin.rds")

top_res=topologyTest(sds=sds, conditions=df$agecut_merged)
saveRDS(top_res, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_topologyTest.rds")

top_res=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_topologyTest.rds")
knitr::kable(top_res)
  # |method     |thresh | statistic| p.value|
  # |:----------|:------|---------:|-------:|
  # |Classifier |0.01   |   0.89939|       0|
...
df=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_Umap.rds")
sds=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_sds_origin.rds")
...
saveRDS(sds_merged, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_sds_merged.rds")
...
df=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_Umap.rds")
sds_merged=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_sds_origin.rds")
prog_res=progressionTest(sds_merged, conditions=df$agecut_merged, global=TRUE, lineages=TRUE)
saveRDS(prog_res, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_progressionTest.rds")

prog_res=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_progressionTest.rds")
knitr::kable(prog_res)
  # |lineage | statistic|   p.value|
  # |:-------|---------:|---------:|
  # |All     | 0.2323529| 0.0000005|
  # |1       | 0.1976125| 0.5885944|
  # |2       | 0.2092308| 0.1666875|
  # |3       | 0.1985714| 0.5570706|
  # |4       | 0.2122222| 0.3155192|
# progression difference in general but cannot identify the specific lineage
...
if (top_res$p.value>0.05) {
  ...
  if (n_lineage>1) {
    ...
    saveRDS(dif_res, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_differentiationTest.rds")
    
    dif_res=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_differentiationTest.rds")
    knitr::kable(dif_res)
  }
}
...
###
df=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_Umap.rds")
sds_merged=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_sds_merged.rds")
fate_res=fateSelectionTest(sds_merged, conditions=df$agecut_merged, global=TRUE, pairwise=TRUE)
saveRDS(fate_res, "~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_fateSelectionTest.rds")

fate_res=readRDS("~/Project_PBMCage/Tempt_RDS/pseudotime_results/PBMCage_Other_fateSelectionTest.rds")
knitr::kable(fate_res)
  # |pair | statistic|   p.value|
  # |:----|---------:|---------:|
  # |All  | 0.2012418| 0.4262991|
  # |1vs2 | 0.2158182| 0.0197622|
  # |1vs3 | 0.1965180| 0.6853252|
  # |1vs4 | 0.1975000| 0.5972760|
  # |2vs3 | 0.1889761| 0.9340980|
  # |2vs4 | 0.1836740| 0.9686573|
  # |3vs4 | 0.1942328| 0.7257910|
# difference in lineage1 and 2, but not in general
...
p=
  ...
  theme_light() +
  labs(x="UMAP_1", y="UMAP_2", title="Innate lymphocytes & innate-like T cells",
...
pdf("~/Project_PBMCage/Plots/PBMCage_Plots/Pseudotime_Trajectory_Others.pdf", height=5, width=7)
plot(p_withLabel)
dev.off()

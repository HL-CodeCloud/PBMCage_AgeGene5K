...
knitr::kable(prog_res)
  ...
  # |:-------|---------:|---------:|
  # |All     | 0.2241897| 0.0000108|
  # |1       | 0.1952632| 0.7437270|
  # |2       | 0.1782143| 0.9980994|
  # |3       | 0.1917065| 0.8713727|
...
# plot_pro=
  ...
  geom_hex(bins=30, aes(fill=after_stat(density))) +
...
pdf("~/Project_PBMCage/Plots/PBMCage_Plots/Pseudotime_Trajectory_Bcells_progression.pdf", height=5, width=10)
plot(plot_pro)
dev.off()
...
knitr::kable(fate_res)
  ...
  # |:----|---------:|---------:|
  # |All  | 0.1878261| 0.9851759|
  # |1vs2 | 0.1933028| 0.8119143|
  # |1vs3 | 0.1927149| 0.8895297|
  # |2vs3 | 0.1932037| 0.8679167|

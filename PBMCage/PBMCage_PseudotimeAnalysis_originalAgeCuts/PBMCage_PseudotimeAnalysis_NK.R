...
sds=slingshot(rd, df$Annot.detailed) # Automate starts at "NK.prolif.MCM", which is nice.
...
pdf("~/Project_PBMCage/Plots/PBMCage_Plots/Pseudotime_Trajectory_NK.pdf", height=5, width=7)
plot(p_withLabel)
dev.off()

...
### Use 300 as the best geneN, the same as in AgeGene5K for comparison
#####################################
###
...
RESULT_DFs=list()
saveRDS(RESULT_DFs, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results.rds")
...
Xu_5000.genes=gene_list$scRNA_ageGenes.ranked
...
training_PBMCage_expr=FetchData(training_PBMCage, vars=c("age","sex","CD8T.naive",gsub("HLA\\.","HLA-",topN_genes)), layer="counts")
...
test_verificombo_expr=FetchData(test_verificombo, vars=c("age","sex","CD8T.naive", gsub("HLA\\.","HLA-",topN_genes)), layer="counts")
...
result_df=list(train.y=train.y,
               test.y=test.y,
               pred=unname(pred))
RESULT_DFs=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results.rds")
...
training_PBMCage$CD8T.naive=score_df
# extract the topN gene expression
training_PBMCage_expr=FetchData(training_PBMCage, vars=c("age","sex","CD8T.naive","condition",gsub("HLA\\.","HLA-",topN_genes)), layer="counts")
...
# extract the expression of the genes used in the training data
test_sle_expr=FetchData(test_sle, vars=c("age","sex","CD8T.naive","condition", gsub("HLA\\.","HLA-",topN_genes)), layer="counts")
...
# extract the expression of the genes used in the training data
test_dataset_expr=FetchData(test_dataset, vars=c("age","sex","CD8T.naive", gsub("HLA\\.","HLA-",topN_genes)), layer="counts")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Zhu et al. (2023)", info="scRNA_ageGenes.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results.txt", sep="\t")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Zhu et al. (2023)", info="scRNA_ageGenes.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results_60To80.txt", sep="\t")
...
RESULT_DFs=list()
saveRDS(RESULT_DFs, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results.rds")
...
# extract the genes
gene_list=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Compare.to.Published_Genesets_GenesetsToCompare.rds")
Xu_5000.ranked=gene_list$scRNA_ageGenes.ranked
Xu_5000.ranked=Xu_5000.ranked[1:300] # take topN genes
# fetch the data
pseudo_data=FetchData(pseudobulkobj_donor, vars=c("donor_id",gsub("HLA\\.","HLA-",Xu_5000.ranked)), layer="data")
...
result_df=list(train.y=train.y,
               test.y=test.y,
               pred=unname(pred))
RESULT_DFs=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results.rds")
RESULT_DFs[[1]]=result_df
...
Xu_5000.ranked=Xu_5000.ranked[1:300] # take topN genes
# fetch the data
PBMCage_expr_data=FetchData(PBMCage_obj_pseudo_donor, vars=c("donor_id",gsub("HLA\\.","HLA-",Xu_5000.ranked)), layer="data")
...
Xu_5000.ranked=Xu_5000.ranked[1:300] # take topN genes
# fetch the data
test_expr_data=FetchData(test_obj_pseudo_donor, vars=c("donor_id",gsub("HLA\\.","HLA-",Xu_5000.ranked)), layer="data")
...
Xu_5000.ranked=Xu_5000.ranked[1:300] # take topN genes
# fetch the data
test_expr_data=FetchData(test_obj_pseudo_donor, vars=c("tube_id",gsub("HLA\\.","HLA-",Xu_5000.ranked)), layer="data")
...
### Save the performance of the PBMCage_RNA freq+GeneExpr model
#####################################
### 
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Zhu et al. (2023)", info="scRNA_ageGenes.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results.txt", sep="\t")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Zhu et al. (2023)", info="scRNA_ageGenes.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results_60TO80.txt", sep="\t")
...
rna_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results.txt", sep="\t")
rna_based$model="RNA-based"
rna_freq_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results.txt", sep="\t")
rna_freq_based$model="RNA.Freq-based"
both_models=data.table::rbindlist(list(rna_based, rna_freq_based))
write.table(both_models, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results_20TO100.txt", sep="\t")

# age range 60-80 only
rna_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results_60To80.txt", sep="\t")
rna_based$model="RNA-based"
rna_freq_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Zhu.et.al.2023_results_60TO80.txt", sep="\t")
rna_freq_based$model="RNA.Freq-based"
both_models=data.table::rbindlist(list(rna_based, rna_freq_based))
write.table(both_models, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Zhu.et.al.2023_results_60TO80.txt", sep="\t")

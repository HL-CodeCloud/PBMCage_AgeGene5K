...
RESULT_DFs=list()
saveRDS(RESULT_DFs, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results.rds")
...
Xu_5000.genes=gene_list$Guro.Dorum_2023.ranked
...
result_df=list(train.y=train.y,
               test.y=test.y,
               pred=unname(pred))
RESULT_DFs=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results.rds")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Dørum et al. (2024)", info="Guro.Dorum_2023.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results.txt", sep="\t")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Dørum et al. (2024)", info="Guro.Dorum_2023.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results_60To80.txt", sep="\t")
...
RESULT_DFs=list()
saveRDS(RESULT_DFs, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results.rds")
...
# extract the genes
gene_list=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Compare.to.Published_Genesets_GenesetsToCompare.rds")
Xu_5000.ranked=gene_list$Guro.Dorum_2023.ranked
...
result_df=list(train.y=train.y,
               test.y=test.y,
               pred=unname(pred))
RESULT_DFs=readRDS("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results.rds")
RESULT_DFs[[1]]=result_df
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Dørum et al. (2024)", info="Guro.Dorum_2023.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results.txt", sep="\t")
...
RESULT_=data.frame(rsq=unlist(RSQs), MAE=unlist(MAEs), MAD=unlist(MADs), RMSE=unlist(RMSEs), dataset=dataset_names, geneset="Dørum et al. (2024)", info="Guro.Dorum_2023.ranked")
write.table(RESULT_, "~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results_60To80.txt", sep="\t")
...
rna_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results.txt", sep="\t")
rna_based$model="RNA-based"
rna_freq_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results.txt", sep="\t")
rna_freq_based$model="RNA.Freq-based"
both_models=data.table::rbindlist(list(rna_based, rna_freq_based))
write.table(both_models, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results_20TO100.txt", sep="\t")

# age range 60-80 only
rna_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results_60To80.txt", sep="\t")
rna_based$model="RNA-based"
rna_freq_based=read.delim("~/Project_PBMCage/For_or_From_Xu/Results/Model.freq_prediction_Dørum.2024_results_60To80.txt", sep="\t")
rna_freq_based$model="RNA.Freq-based"
both_models=data.table::rbindlist(list(rna_based, rna_freq_based))
write.table(both_models, "~/Project_PBMCage/For_or_From_Xu/Results/Model_prediction_Dørum.2024_results_60TO80.txt", sep="\t")
